...
namespace MemoryWords
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            #region Run Tests
            Console.WriteLine("Testing using: {0}", "wiktionary_frequency_list.txt");
            string inputFile5k = Path.Combine(DictPath, "wiktionary_frequency_list.txt");
            ...
            WriteCSV(outputDir, "pi_list5k.csv", digits, wordList5k);
            ...
            Console.WriteLine("Testing using: {0}", "ord10000.txt");
            string inputFile10000 = Path.Combine(DictPath, "ord10000.txt");
            ...
            WriteCSV(outputDir, "pi_list10000.csv", digits, wordList10000);
            ...
            Console.WriteLine("Testing using: {0}", "ord10k.csv");
            string inputFile10k = Path.Combine(DictPath, "ord10k.csv");
            ...
            WriteCSV(outputDir, "pi_list10k.csv", digits, wordList10k);
            ...
            Console.WriteLine("Testing using: {0}", "norwegian.txt");
            string inputFile62K = Path.Combine(DictPath, "norwegian.txt");
            string dictionary62K = File.ReadAllText(inputFile62K, _isoLatin1Encoding);
            var wordList62K = FindWords(dictionary62K, digits, true);
            WriteCSV(outputDir, "pi_list62K.csv", digits, wordList62K);
